...
FINAL_RESPONSE_CALLBACK_URL = os.getenv("FINAL_RESPONSE_CALLBACK_URL", "").strip()
FINAL_RESPONSE_CALLBACK_TIMEOUT_SECONDS = max(
    5,
    int(os.getenv("FINAL_RESPONSE_CALLBACK_TIMEOUT_SECONDS", "20")),
)
FINAL_RESPONSE_CALLBACK_INCLUDE_AUTH_HEADER = env_flag("FINAL_RESPONSE_CALLBACK_INCLUDE_AUTH_HEADER", True)
FINAL_RESPONSE_CALLBACK_INCLUDE_AUTH_TOKEN_BODY = env_flag("FINAL_RESPONSE_CALLBACK_INCLUDE_AUTH_TOKEN_BODY", False)
COBRA_GATEWAY_WARMUP_RETRIES = max(0, int(os.getenv("COBRA_GATEWAY_WARMUP_RETRIES", "1")))
COBRA_GATEWAY_WARMUP_RETRY_SECONDS = max(1, int(os.getenv("COBRA_GATEWAY_WARMUP_RETRY_SECONDS", "2")))
OPENCLAW_PROTOCOL_VERSION = 3
GATEWAY_SCOPES = ["operator.admin", "operator.write", "operator.approvals", "operator.pairing"]
